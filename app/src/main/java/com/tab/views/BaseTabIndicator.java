...
import com.inidicator.helper.ViewPagerHelper;
...
import com.inidicator.impl.titles.SimplePagerTitleView;
import com.tab.R;

/**
 * 基础的可以自扩展的TabIndicator    Liangchaojie
 */
public class BaseTabIndicator extends FrameLayout implements OnPageListener{
    ...
    public BaseTabIndicator(@NonNull Context context) {
        this(context,null);
    }

    public BaseTabIndicator(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public BaseTabIndicator(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public void setupWithViewPager(ViewPager viewPager){
        ...
        BaseViewPagerHelper.bind(this,viewPager);
    ...
    private IPagerNavigator getDefaultNavigator(final ViewPager viewPager){
        if(viewPager!=null) this.viewPager = viewPager;
